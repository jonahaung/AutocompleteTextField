...
open class AutocompleteTextField: UITextField, UITextFieldDelegate {
    ...
    public var highlightColor = UIColor.blue.withAlphaComponent(0.2)
    ...
    private func setCompletion(_ completion: String) {
        ...
        let completion = completion.substring(from: completion.index(completion.startIndex, offsetBy: text.utf16.count))
